					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-default">
							<div class="panel-body">
								<a href="#edit-comunidad" class="skip" tabindex="-1"><g:message
								...
								<div id="edit-comunidad" class="content scaffold-edit"
									role="main">
									<h1>
									...
									<g:form url="[resource:comunidadInstance, action:'update2']"
										method="PUT">
										<g:hiddenField name="version"
											value="${comunidadInstance?.version}" />
										<fieldset class="form">
