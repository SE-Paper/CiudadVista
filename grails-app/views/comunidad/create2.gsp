					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-default">
							<div class="panel-body">
								<a href="#create-comunidad" class="skip" tabindex="-1"><g:message
								...
								<div id="create-comunidad" class="content scaffold-create"
									role="main">
									<h1>
									...
									<g:form url="[resource:comunidadInstance, action:'save2']">
										<fieldset class="form">
