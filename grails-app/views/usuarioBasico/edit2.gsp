				...
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						...
						<div class="panel-body">
								<a href="#edit-usuarioBasico" class="skip" tabindex="-1"><g:message
								...
								<div id="edit-usuarioBasico" class="content scaffold-edit"
									role="main">
									<h1>
									...
									<g:form url="[resource:usuarioBasicoInstance, action:'update2']"
										method="PUT" enctype="multipart/form-data">
										<g:hiddenField name="version"
											value="${usuarioBasicoInstance?.version}" />
										<fieldset class="form">
