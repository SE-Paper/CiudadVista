					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-default">
							<div class="panel-body">
								<a href="#create-grupoUsuarios" class="skip" tabindex="-1"><g:message
								...
								<div id="create-grupoUsuarios" class="content scaffold-create"
									role="main">
									<h1>
									...
									<g:form url="[resource:grupoUsuariosInstance, action:'save2']">
										<fieldset class="form">
