					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-default">
							<div class="panel-body">
								<a href="#edit-grupoUsuarios" class="skip" tabindex="-1"><g:message
								...
								<div id="edit-grupoUsuarios" class="content scaffold-edit"
									role="main">
									<h1>
									...
									<g:form url="[resource:grupoUsuariosInstance, action:'update2']"
										method="PUT">
										<g:hiddenField name="version"
											value="${grupoUsuariosInstance?.version}" />
										<fieldset class="form">
											<g:render template="form" />
										</fieldset>
										<fieldset class="buttons">
											<g:actionSubmit class="save" action="update2"
