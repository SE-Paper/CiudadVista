					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-default">
							<div class="panel-body">
								<a href="#list-sitio" class="skip" tabindex="-1"><g:message
										...
										<thead>
											<tr>
												...
												<g:sortableColumn property="nombreComponente"
													title="${message(code: 'sitio.nombreComponente.label', default: 'Nombre Componente')}" />

												<g:sortableColumn property="activo"
													title="${message(code: 'sitio.activo.label', default: 'Activo')}" />

												<g:sortableColumn property="resumen"
													title="${message(code: 'sitio.resumen.label', default: 'Resumen')}" />

												<g:sortableColumn property="ranking"
													title="${message(code: 'sitio.ranking.label', default: 'Ranking')}" />

												<g:sortableColumn property="telefono"
													title="${message(code: 'sitio.telefono.label', default: 'Telefono')}" />

												<g:sortableColumn property="direccion"
													title="${message(code: 'sitio.direccion.label', default: 'Direccion')}" />

											</tr>
										</thead>
										<tbody>
											<g:each in="${sitioInstanceList}" status="i"
												var="sitioInstance">
												<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">

													<td><g:link action="show2" id="${sitioInstance.id}">
															${fieldValue(bean: sitioInstance, field: "nombreComponente")}
														</g:link></td>

													<td><g:formatBoolean boolean="${sitioInstance.activo}" /></td>

													<td>
														${fieldValue(bean: sitioInstance, field: "resumen")}
													</td>

													<td>
														${fieldValue(bean: sitioInstance, field: "ranking")}
													</td>

													<td>
														${fieldValue(bean: sitioInstance, field: "telefono")}
													</td>

													<td>
														${fieldValue(bean: sitioInstance, field: "direccion")}
													</td>
