					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-default">
							<div class="panel-body">
								<a href="#edit-servicio" class="skip" tabindex="-1"><g:message
								...
								<div id="edit-servicio" class="content scaffold-edit"
									role="main">
									<h1>
									...
									<g:form url="[resource:servicioInstance, action:'update2']"
										method="PUT" enctype="multipart/form-data">
										<g:hiddenField name="version"
											value="${servicioInstance?.version}" />
										<fieldset class="form">
