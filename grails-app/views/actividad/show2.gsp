					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-default">
							<div class="panel-body">
								<a href="#show-actividad" class="skip" tabindex="-1"><g:message
								...
								<div id="show-actividad" class="content scaffold-show"
									role="main">
									<h1>
									...
									<g:form url="[resource:actividadInstance, action:'delete2']"
										method="DELETE">
										<fieldset class="buttons">
											<g:link class="edit" action="edit2"
												resource="${actividadInstance}">
