					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-default">
							<div class="panel-body">
								<a href="#edit-actividad" class="skip" tabindex="-1"><g:message
								...
								<div id="edit-actividad" class="content scaffold-edit"
									role="main">
									<h1>
									...
									<g:form url="[resource:actividadInstance, action:'update2']"
										method="PUT" enctype="multipart/form-data">
										<g:hiddenField name="version"
											value="${actividadInstance?.version}" />
										<fieldset class="form">
