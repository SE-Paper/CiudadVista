...
<body>
	<div id="wrapper">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-default">
							<div class="panel-body">
								...
								<a href="#edit-usuarioAdministrador" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-usuarioAdministrador" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:usuarioAdministradorInstance, action:'update2']" method="PUT" >
				<g:hiddenField name="version" value="${usuarioAdministradorInstance?.version}" />
				<fieldset class="form">
