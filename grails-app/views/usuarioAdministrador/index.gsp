					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-default">
							<div class="panel-body">
								<a href="#list-usuarioAdministrador" class="skip" tabindex="-1"><g:message
								...
								<div id="list-usuarioAdministrador"
										...
										<thead>
											<tr>
												...
												<g:sortableColumn property="email"
													title="${message(code: 'usuarioAdministrador.email.label', default: 'Email')}" />

												<g:sortableColumn property="password"
													title="${message(code: 'usuarioAdministrador.password.label', default: 'Password')}" />

												<g:sortableColumn property="activo"
													title="${message(code: 'usuarioAdministrador.activo.label', default: 'Activo')}" />

											</tr>
										</thead>
										<tbody>
											<g:each in="${usuarioAdministradorInstanceList}" status="i"
												var="usuarioAdministradorInstance">
												<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">

													<td><g:link action="show"
															id="${usuarioAdministradorInstance.id}">
															${fieldValue(bean: usuarioAdministradorInstance, field: "email")}
														</g:link></td>

													<td>
														${fieldValue(bean: usuarioAdministradorInstance, field: "password")}
													</td>

													<td><g:formatBoolean
															boolean="${usuarioAdministradorInstance.activo}" /></td>
