					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-default">
							<div class="panel-body">
								<a href="#edit-usuarioAdministrador" class="skip" tabindex="-1"><g:message
								...
								<div id="edit-usuarioAdministrador"
									...
									<g:hasErrors bean="${usuarioAdministradorInstance}">
										<ul class="errors" role="alert">
											<g:eachError bean="${usuarioAdministradorInstance}"
												var="error">
												<li
									...
									<g:form
										url="[resource:usuarioAdministradorInstance, action:'update']"
										method="PUT">
										<g:hiddenField name="version"
											value="${usuarioAdministradorInstance?.version}" />
										<fieldset class="form">
