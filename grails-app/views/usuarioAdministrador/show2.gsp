...
<body>
	<div id="wrapper">
		...
		<div id="show-usuarioAdministrador" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:usuarioAdministradorInstance, action:'delete2']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit2" resource="${usuarioAdministradorInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
